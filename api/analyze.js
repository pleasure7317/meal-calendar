...
const MENU_GLOSSARY = [
    ...
    '마늘쫑볶음', '멸치볶음', '어묵볶음', '진미채볶음', '오징어채볶음', '감자조림', '연근조림', '우엉조림', '미역줄기볶음', '햄마늘쫑볶음', '소시지야채볶음', '잡채', '비엔나볶음', '비엔나야채볶음',
...
- **동의어·유의어로 절대 바꾸지 마세요.** 뜻이 같아도 이미지에 적힌 그 단어를 그대로 쓰세요. 예: '야채'를 '채소'로, '계란'을 '달걀'로, '돈육'을 '돼지고기'로, '간장'을 '진간장'으로, '볶음'을 '볶이'로 바꾸지 말 것. 이미지가 '비엔나야채볶음'이면 반드시 '비엔나야채볶음'(채소로 바꾸지 말 것).
- 표준어로 고치거나 띄어쓰기를 임의로 바꾸지 말고, 오타처럼 보여도 이미지에 적힌 그대로 옮기세요.
