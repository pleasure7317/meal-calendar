...
- 각 메뉴 뒤에 1인분 기준 영양 추정치를 "(칼로리kcal, 탄N g, 단N g, 지N g)" 형식으로 붙이세요. 예: "제육볶음 (520kcal, 탄25g, 단30g, 지28g)". 탄=탄수화물, 단=단백질, 지=지방(그램). 메뉴 특성에 맞게 현실적으로 추정하세요(밥은 탄수↑, 고기는 단백질·지방↑ 등). 단, **메뉴 이름 자체는 절대 영양 추정 때문에 바꾸지 마세요.** 영양 정보는 항상 메뉴 이름 뒤 괄호 안에만 적으세요.
